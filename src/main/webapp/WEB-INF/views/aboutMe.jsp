	        ...
	        <div class="col-12 pt-5">
	            <div class="card mb-3">
	                <div class="card-body">
	                    ...
	                    that with programming the possibilities for learning are seemingly endless and I can create without needing the budget or space for a project vehicle and parts. 
	                    </p>
	                </div>
	            </div>
	            <div class="card mb-3">
